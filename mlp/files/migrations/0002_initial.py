...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('file_tag', (
            ...
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name='filetag_set', to=orm['tags.Tag'])),
        ))
    ...
    models = {
        ...
        u'files.filetag': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filetag_set'", 'to': u"orm['tags.Tag']"}),
